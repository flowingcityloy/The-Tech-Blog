...
const commentdata = [
    ...
    {
        comment_text: 'Marbi odio odio, elemntum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.',
        user_id: 6,
        post_id: 8
    },
    {
        comment_text: 'Aliquam erat volutpat. In conque.',
        user_id: 3,
        post_id: 10
    },
    {
    ...
    {
        comment_text: 'Vestibulum retrum retrum neque. Aenean auctor gravida sem.',
        user_id: 8,
        post_id: 2
    },
    {
    ...
    {
        comment_text: 'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubillia Curae; Nulla dapibus dolor vel est.',
        user_id: 5,
        post_id: 13
    },
    {
        comment_text:
        'Donec ut mauris eget massa tempor convallis. Nulla neque libero, conavllis eget, eleifend luctus, ultricies eu, nibh.',
        user_id: 9,
        post_id: 16
    },
    {
    ...
    {
        comment_text: 'Morbi non quam nec dui luctus retrum.',
        user_id: 3,
        post_id: 8
    },
    {
    ...
    {
        comment_text: 'Maecenas ut massa quis auque luctus tincidunt.',
        user_id: 10,
        post_id: 8
    },
    {
    ...
    {
        comment_text: 'Fusce conque, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat.',
        user_id: 5,
        post_id: 4
    },
    {
    ...
    {
        comment_text: 'Vestibulum ac est lacinia nist venenatis tristique.',
        user_id: 4,
        post_id: 6
    },
    {
